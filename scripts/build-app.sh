...
<key>CFBundleName</key><string>Handoff</string>
<key>CFBundleDisplayName</key><string>Handoff</string>
...
<key>NSAppleEventsUsageDescription</key><string>Handoff reads selected spreadsheet or mail context and runs the app actions you review and approve.</string>
</dict></plist>
PLIST
