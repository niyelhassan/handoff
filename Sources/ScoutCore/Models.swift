...
public enum Operation: String, Codable, CaseIterable {
    ...
    case readCSV, appendCSV, transformTable, writeCSV, resizeImage, convertImage, driveTime, createFolder
    ...
    public var touchesUI: Bool { ![.waitForFile,.renameFile,.moveFile,.copyFile,.readCSV,.appendCSV,.transformTable,.writeCSV,.resizeImage,.convertImage,.driveTime,.createFolder,.forEach,.endLoop,.ifMatches,.endIf,.ask].contains(self) }
