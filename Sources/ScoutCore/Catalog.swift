...
public enum Catalog {
    public static let arguments: [Operation:[String]] = [
        ...
        .readCSV:["path","output"], .appendCSV:["path","columns","values"], .transformTable:["table","action","column","value","output"], .writeCSV:["table","path"], .resizeImage:["source","destination","width","height"], .convertImage:["source","destination","format"], .driveTime:["origin","destination","output"],
